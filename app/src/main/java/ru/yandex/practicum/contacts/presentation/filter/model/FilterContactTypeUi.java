...
import ru.yandex.practicum.contacts.presentation.base.ListDiffInterface; // Добавленный импорт
...
public class FilterContactTypeUi implements ListDiffInterface<FilterContactTypeUi> {
    ...
    @Override
    public boolean theSameAs(@NonNull FilterContactTypeUi newItem) { // Добавлена аннотация @NonNull
